...
public class ListViewModel extends AndroidViewModel {
    ...
    public void refresh(){
        DogBreed dog1=new DogBreed("1","corgi0","15 years","","","","");
        DogBreed dog2=new DogBreed("2","rotwailer","10 years","","","","");
        DogBreed dog3=new DogBreed("3","labrador","15 years","","","","");
        DogBreed dog4=new DogBreed("1","corgi0","15 years","","","","");
        DogBreed dog5=new DogBreed("2","rotwailer","10 years","","","","");
        DogBreed dog6=new DogBreed("3","labrador","15 years","","","","");
        DogBreed dog7=new DogBreed("1","corgi0","15 years","","","","");
        DogBreed dog8=new DogBreed("2","rotwailer","10 years","","","","");
